      ...
      <div className={styles.container}>
        ...
        <main className={styles.main}>
          ...
          <div className={styles.grid}>
            <div className={styles.card}><Donut_box name={"Donut Home Simpson"}/></div>
            <div className={styles.card}><Donut_box name={"Donut Home Simpson"}/></div>
            <div className={styles.card}><Donut_box name={"Donut Home Simpson"}/></div>
            <div className={styles.card}><Donut_box name={"Donut Home Simpson"}/></div>
            <div className={styles.card}><Donut_box name={"Donut Home Simpson"}/></div>
          ...
          <div className={styles.footer_items}>
            ...
            <div>
              <p>
                ...
                fisicamente em Campo Grande e Santa Cruz, bairros da zona oeste
                do Rio de Janeiro. Além de entregas por encomenda para eventos,
